...
set GCODE_VIEWER_JAR=D:\CEL\GitHub\GCodeViewer\release\GCodeViewer.jar
set GCODE_VIEWER_JSON=D:\CEL\GitHub\GCodeViewer\release
set GCODE_VIEWER_CONFIG=D:\CEL\GitHub\GCodeViewer\GCodeViewerFake.configFile.xml
